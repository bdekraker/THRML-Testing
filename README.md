...
<p align="center">
  <img alt="ESS/sec vs samples/sec (Pareto)" src="outputs/bench_tradeoff_ess.png" width="60%"><br>
  <img alt="Raw throughput: samples/sec" src="outputs/bench_tradeoff.png" width="45%">
</p>
...
- Leaderboard-ready JSON (with scaling + J sweep metadata) lives at [`gpu_checkerboard_sps6.json`](https://github.com/bdekraker/THRML-Leaderboard/blob/main/results/gpu_checkerboard_sps6.json). Both the CPU and GPU entries are published on [thrmlbench.com](https://thrmlbench.com).
