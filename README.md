...
**Takeaway:** At similar throughput, **checkerboard yields higher ESS/sec** (effective samples per wall-time) than random in our runs—~**1.4–2.2×** better depending on seed.
...
- `outputs/bench_tradeoff_ess.png`, `outputs/bench_tradeoff.png` — plots above
